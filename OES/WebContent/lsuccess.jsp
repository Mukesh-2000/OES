...
String connectionUrl = "jdbc:sqlite:C:\\Users\\Mukesh\\OneDrive\\Desktop\\dbs\\"+"student.db";
...
ResultSet resultSet = null;
	...
	{ 
		...
		connection = DriverManager.getConnection("jdbc:sqlite:C:\\Users\\Mukesh\\OneDrive\\Desktop\\dbs\\"+"student.db");
	...
	response.sendRedirect("http://localhost:8080/OES/log.jsp");
}
	}
